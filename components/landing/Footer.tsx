...
export function Footer() {
    return (
        <footer id="contact" className="bg-primary dark:bg-slate-950 text-white py-12 border-t border-primary-light/20 dark:border-border">
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-3">
                        <li><Link href="/#presentation" className="text-white/70 dark:text-muted-foreground hover:text-white transition-colors">Présentation</Link></li>
                        ...
                        <li><Link href="/#contact" className="text-white/70 dark:text-muted-foreground hover:text-white transition-colors">Contact</Link></li>
                    </ul>
                </div>
            </div>
